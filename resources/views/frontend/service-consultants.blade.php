...
<header id="header" class="header sticky-top">
  ...
  <main class="main">
    ...
    style="
        background: url('{{ asset('consultants/banner/' . ($consultant->banner_image ?? 'default.webp')) }}') center center no-repeat;
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <ul class="bread-list">
             ...
             <li><a href="#">Hospital Practice<i class="fa fa-angle-right"></i></a></li>
              <li class="active"><a href="javascript:void(0)">Consultants</a></li>
            </ul>
          </div>
        </div>
      </div>
...
<section class="consultants-one-sec">
  <div class="container">
    ...
    <div class="consultants-one-title-sec">
      <h2>{{ $consultant->heading ?? 'Consultants' }}</h2>
    </div>
    ...
    <div class="consultants-row-sec">
      <div class="row">
        ...
        @php
          $details = is_array($consultant->details) 
                     ? $consultant->details 
                     : json_decode($consultant->details, true);

    ...
    <div class="container">
        ...
        <div id="progressWrapper" class="creative-progress">
            ...
            <ul class="progress-steps">
                ...
                <li data-step="8"><span>Step 8</span></li>
                </ul>
        </div>
                ...
                <div id="form-step-wrap" class="application-form-step-sec">
                    ...
                    <div id="step1box" class="slider-step first-step af-border-sec" data-next-step="step2Box" data-step="1">
                        ...
                        <form id="step1Form" class="row g-3">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="af-registration-year-picker" name="registration_year" placeholder="Year of Above Registration (YYYY)">
                            
                            </div>
                            
                            
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="af-qualification-year-picker" name="qualification_year" placeholder="Year of Qualification (YYYY)">
                            </div>
                        ...
                        <form id="step3Form" class="row g-3">
                            ...
                            <div class="col-md-12">
                                <div class="row app-form-custom-btn-row">
                                    ...
                                    <div class="col-4">
                                        <button type="button" class="form-control app-form-btn">Save Draft</button>
                                    </div>
...
<br>
                    ...
                    <!-- STEP 7 : DESIGNATED BODY -->
                    <div id="step7Box" class="slider-step af-border-sec"
                         data-next-step="step8Box"
                         data-back-to="step6Box"
                         data-step="7">
                        ...
                        <div class="app-form-title-subsec">
                            <h4>Designated Body</h4>
                            <p>
                                DDPU is a Designated Body (DB) under Regulation 4.
                                <br>
If you are eligible, you may nominate DDPU to act as your Designated Body for appraisal and revalidation.
                            </p>
                        </div>
                    
                        <form id="step7Form" class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-check app-form-checkbox-custom-sec">
                                    <input class="form-check-input"
                                           type="checkbox"
                                           id="ddpu-consent-checkbox"
                                           name="ddpu_consent"
                                           value="yes">
                                    <label class="form-check-label" for="ddpu-consent-checkbox">
                                        I confirm that I would like DDPU to act as my Designated Body (if eligible)
                                    </label>
                                </div>
                            </div>
                          ...
                          <!-- LAST APPRAISAL DATE -->
<div class="col-md-6">
    <small class="text-muted d-block mb-1">Enter Last Appraisal Date</small>
    <input type="text"
       name="last_appraisal_date"
       id="last-appraisal-date-sec"
       class="form-control"
       placeholder="Please enter Last Appraisal Date DD / MM / YYYY">
</div>

<!-- APPRAISAL FILE -->
<div class="col-md-6">
    <small class="text-muted d-block mb-1">Upload Last Appraisal Document ((Max file size: 5 MB)
 )</small>
    <input type="file"
           name="last_appraisal_file"
           class="form-control"
           id="last-appraisal-file-sec"
           accept=".pdf,.jpg,.jpeg,.png">
</div>

<!-- REVALIDATION DATE -->
<div class="col-md-6">
    <small class="text-muted d-block mb-1">Enter Revalidation Date</small>
    <input type="text"
           name="revalidation_date"
           class="form-control text-date"
           id="revalidation-date-sec"
           placeholder="Please enter Revalidation Date DD / MM / YYYY"
           readonly>
</div>

<!-- LAST DB NAME -->
<div class="col-md-6">
    <small class="text-muted d-block mb-1">Current or Last Designated Body</small>
    <input type="text"
           name="last_db_name"
           class="form-control"
           placeholder="Enter Designated Body Name">
</div>
                            ...
                            <div class="col-md-12">
                                <div class="row app-form-custom-btn-row">
                                    ...
                                    <div class="col-4">
                                        <button type="button"
                                                class="form-control btn-back app-form-btn">
                                            Previous
                                        </button>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <button type="button"
                                                class="form-control app-form-btn save-draft-btn">
                                            Save Draft
                                        </button>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <button type="button"
                                                class="btn-next btn-success form-control app-form-btn"
                                                data-next-step="step8Box">
                                            Continue
                                        </button>
                                    </div>
                 ...
                 <div id="step8Box" class="slider-step af-border-sec" data-back-to="step7Box" data-step="8">
                        ...
                        <div class="app-form-title-subsec">
                            ...
                            <p>Please review all information you entered in Steps 1 to 7.</p>
                        </div>
  ...
  <!--<div id="preloader"></div>-->
    ...
    if (e.target.classList.contains("btn-next")) {
        ...
        // Small delay so step change happens first
        setTimeout(function () {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                for (let i = 0; i < select.options.length; i++) {
                    if (select.options[i].text.toLowerCase() === countryName.toLowerCase()) {
...
<script>
document.addEventListener("click", function(e) {
    if (!document.getElementById("app-form-postal-code").contains(e.target)) {
        resultBox.style.display = "none";
    }
});
...
/* ============================================================
=  STEP 8 - PREVIEW GENERATOR (AFTER DESIGNATED BODY STEP)
============================================================ */

document.addEventListener("DOMContentLoaded", function () {

    // Trigger preview when entering Step 8
    document.querySelectorAll(".btn-next").forEach(btn => {
        btn.addEventListener("click", function () {

            const nextStep = this.dataset.nextStep || this.closest(".slider-step").dataset.nextStep;

            if (nextStep === "step8Box") {
                generatePreview();
            }
        });
    });
...
function generatePreview() {
    ...
    const fields = document.querySelectorAll(
        "#step1box [name],#step2Box [name],#step3Box [name],#step4Box [name],#step5Box [name],#step6Box [name],#step7Box [name]"
    );
    ...
    fields.forEach(field => {
        ...
        // label inside parent column
        if (!labelText) {
            const parentDiv = field.closest(".col-12, .col-md-6, .col-md-12");
            if (parentDiv) {
        ...
        // fallback from name
        if (!labelText) {
            labelText = field.name.replace(/_/g, " ").toUpperCase();
        }
        ...
        if (field.type === "checkbox") {
            ...
            value = field.selectedIndex > 0
                ? field.options[field.selectedIndex].text.toUpperCase()
                : "<em>NA</em>";
        }
        else {
        ...
        html += `
            <tr>
                <td class="preview-label">${labelText}</td>
...
/* ============================================================
=  AUTO FILL FROM DATABASE (EDIT MODE)
============================================================ */
...
function fillFormFromDB(app) {
    ...
    steps.forEach(stepKey => {
        ...
        try {
            stepData = typeof app[stepKey] === "string"
                ? JSON.parse(app[stepKey])
                : app[stepKey];
        } catch (e) {
            console.error("Invalid JSON in " + stepKey);
            return;
        }
...
document.getElementById("finalSubmitBtn").addEventListener("click", async function () {
    ...
    try {
        ...
        fields.forEach(field => {
            ...
            if (field.type === "checkbox") {
                ...
                if (field.files.length > 0) {
                    fd.append(`files[${field.name}]`, field.files[0]);
                }
                return;
            }
            else {
        ...
        if (result.status === "success") {
            ...
            setTimeout(() => {
                window.location.href = "/DDPU/Signup-form/" + result.user_id;
            }, 1800);
...
function updateFormHeight() {
    ...
    if (active && wrap) {
        const buffer = 20;
        const totalHeight = active.scrollHeight + buffer;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    wrapper.addEventListener("click", function(e) {
        ...
        const btnDraft = target.closest(".btn-save-draft"); // Added draft button selector

        // Check if any of the functional buttons were clicked
        if (btnNext || btnBack || btnDraft) {
            ...
            // If it's just a "Save Draft" without a step change, we stop here.
            // If it's Next/Back, we continue with the transition logic.
            if (btnNext || btnBack) {
                const currentStep = (btnNext || btnBack).closest(".slider-step");
...
if(step === 4 && !document.querySelector(".pni-option:checked")) {
    ...
    let consent = document.getElementById("ddpu-consent-checkbox").checked;

    if(consent){

        if(!val("last-appraisal-date-sec")){
            showError("last-appraisal-date-sec","Please enter Last Appraisal Date");
            valid = false;
        }

        // if(!val("revalidation-date-sec")){
        //     showError("revalidation-date-sec","Please enter Revalidation Date");
        //     valid = false;
        // }
...
/* =========================================================
=  NEXT BUTTON (MAIN CONTROL - CLEAN VERSION)
========================================================= */
...
document.querySelectorAll(".btn-next").forEach(function (btn) {
    ...
    btn.addEventListener("click", async function () {
        ...
        var isFinal = (btn.value === "submit" && currentStep === 7);
        ...
        form.querySelectorAll("[name]").forEach(function (inp) {
            ...
            if (inp.type === "file") {
                if (inp.files.length > 0) {
                    fd.append("data[" + inp.name + "]", inp.files[0]);
                }
            } else if (inp.type === "checkbox") {
                fd.append("data[" + inp.name + "]", inp.checked ? 1 : 0);
            } else {
                fd.append("data[" + inp.name + "]", inp.value);
            }
...
window.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        // ✅ FILL FORM FROM DB
        if (data.data) {
            fillFormFromDB(data.data);
        }

        // ✅ SHOW STEP
        showStep(currentStep);

        // ✅ IF STEP 7 → build preview
        if (currentStep == 8) {
            generatePreview();
        }
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function initYearPicker(selector) {
        ...
        flatpickr(selector, {
            dateFormat: "Y",   // only year will be saved
            allowInput: true,
            ...
            onChange: function(selectedDates, dateStr, instance) {
                if (selectedDates.length) {
                    ...
                    instance.input.value = year;   // set only year in input
                }
            }
        });
    }

    initYearPicker("#af-registration-year-picker");
    initYearPicker("#af-qualification-year-picker");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    flatpickr(dobInput, {
        ...
        allowInput: true,
        clickOpens: true,
        maxDate: eighteenYearsAgo, // prevents selecting date < 18 years
    });

    // extra validation in case user types manually
    dobInput.addEventListener("blur", function () {
        const val = dobInput.value;
        if (!val) return; // empty, skip
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    flatpickr("#prev-membership-expiry", {
        dateFormat: "d/m/Y",   // format you want
        allowInput: true,      // allow manual typing
        clickOpens: true       // click anywhere opens calendar
    });
...
//     flatpickr("#last-appraisal-date-sec", {
//         dateFormat: "d/m/Y",   // format you want
//         allowInput: true,      // allow manual typing
//         clickOpens: true       // click anywhere opens calendar
//     });
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    flatpickr("#revalidation-date-sec", {
        dateFormat: "d/m/Y",   // format you want
        allowInput: true,      // allow manual typing
        clickOpens: true       // click anywhere opens calendar
    });

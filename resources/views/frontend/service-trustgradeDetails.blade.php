...
<header id="header" class="header sticky-top">
  ...
  <main class="main">
    ...
    style="
        background: url('{{ asset('TrustGradeDetails/banner/' . ($trustgradeDetails->banner_image ?? 'default.webp')) }}') center center no-repeat;
...
<section class="consultants-one-sec">
  <div class="container">
    ...
    <div class="consultants-one-title-sec">
      <h2>{{ $trustgradeDetails->heading ?? 'The Services Available Trust grade and ad-hoc appointees in the NHS' }}</h2>
    </div>
    ...
    <div class="consultants-row-sec">
      <div class="row">
        ...
        @php
          $details = is_array($trustgradeDetails->details) 
                     ? $trustgradeDetails->details 
                     : json_decode($trustgradeDetails->details, true);

                ...
                <div class="card">
                  <div class="card-body">
                      ...
                      <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb mb-0">
                          <li class="breadcrumb-item">
                            <a href="{{ route('customer-elctronic.details') }}">Home</a>
                          </li>
                          <li class="breadcrumb-item active" aria-current="page">Join Customer Electronic Details</li>
                        </ol>
                      </nav>
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('customer-electronic.export', 'csv') }}"

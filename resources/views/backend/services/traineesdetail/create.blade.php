...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h4>Add Trainees Details Form</h4>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Trainees Details</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <form class="row g-4"
                      action="{{ route('trainees-details.store') }}"
                      method="POST"
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">Trainees Details</h5>

...
<div class="container-fluid">
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-6">
                <h4>Edit Non Membership Details Form</h4>
            </div>
            <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ route('for-non-members-details.index') }}">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Edit For Non Membership Details</li>
                </ol>
            </div>
        </div>
    </div>
   ...
   <div class="card mt-3">
    <div class="card-header">
        <h4>For Non Membership Details</h4>
    </div>

    <div class="card-body">
<form class="row g-4"
      action="{{ route('for-non-members-details.update', $fornonmembers->id) }}"
      method="POST"
    ...
    <div class="position-relative d-inline-block mt-2">
        ...
        @if($fornonmembers->banner_image)
            <img id="bannerPreview"
                 src="{{ asset('fornonmembers/banner/'.$fornonmembers->banner_image) }}"
                 width="150"
...
<div class="col-md-6">
    ...
    <div class="position-relative d-inline-block mt-2">
        ...
        @if($fornonmembers->main_image)
            <img id="mainPreview"
                 src="{{ asset('fornonmembers/main/'.$fornonmembers->main_image) }}"
                 width="150"
                 style="border:1px solid #ddd; padding:5px; border-radius:6px;">
        @else
            <img id="mainPreview"
...
<div class="col-md-12">
    ...
    <textarea name="description"
              ...
              class="form-control"
              rows="6"
              required>{{ $fornonmembers->description }}</textarea>
</div>


<!-- ================= SUBMIT ================= -->
<div class="col-12 text-end">
            <a href="{{ route('for-non-members-details.index') }}" class="btn btn-danger px-4">Cancel</a>

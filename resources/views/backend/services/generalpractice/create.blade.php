...
<div class="container-fluid">
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-6">
                <h4>Add General Practice Details Form</h4>
            </div>
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add General Practice Details</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="card mt-3">
    ...
    <div class="card-body">
        <form class="row g-4"
              action="{{ route('general-practice-details.store') }}"
              method="POST"
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-light d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-semibold">Practice Features</h5>

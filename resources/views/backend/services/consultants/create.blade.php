...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h4>Add Consultants Details Form</h4>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Consultants Details</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <form class="row g-4"
                      action="{{ route('consultants-details.store') }}"
                      method="POST"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addBtn.addEventListener('click', function () {
        ...
        newRow.innerHTML = `
            ...
            <td><textarea name="description[]" class="form-control editor" placeholder="Description" required></textarea></td>

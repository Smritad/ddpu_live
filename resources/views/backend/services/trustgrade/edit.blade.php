...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h4>Edit Trust Grade Details Form</h4>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Trust Grade Detail</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <form class="row g-4"
      action="{{ route('trust-grade-details.update', $trustgradedetails->id) }}"
      method="POST"
    ...
    <div class="position-relative d-inline-block mt-2">
        <img id="bannerPreview"
             src="{{ asset('TrustGradeDetails/banner/'.$trustgradedetails->banner_image) }}"
             width="150"
...
<div class="col-md-12">
    ...
    <input type="text" name="heading" class="form-control"
           placeholder="Heading"
           value="{{ $trustgradedetails->heading }}" required>
</div>
...
<div class="col-md-12 mt-4">
    <div class="card border-0 shadow-sm">
        ...
        <th width="100">Action</th>
                ...
                <tbody>
                    @foreach ($trustgradedetails->details as $detail)
                        <tr class="detailRow">
                            <td>
                    ...
                    @endforeach
                    @if(count($trustgradedetails->details) == 0)
                        <tr class="detailRow">
...
<div class="col-12 text-end">
    ...
    <a href="{{ route('trust-grade-details.index') }}" 

...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h4>Edit SAS Doctors Details Form</h4>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit SAS Doctors Details</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <form class="row g-4"
      action="{{ route('sas-doctors-grades-details.update', $sasdoctorsnontraining->id) }}"
      method="POST"
    ...
    <div class="position-relative d-inline-block mt-2">
        <img id="bannerPreview"
             src="{{ asset('SasDoctorsNonTrainingGrades/banner/'.$sasdoctorsnontraining->banner_image) }}"
             width="150"
...
<div class="col-md-12">
    ...
    <input type="text" name="heading" class="form-control"
           placeholder="Heading"
           value="{{ $sasdoctorsnontraining->heading }}" required>
</div>
...
<div class="col-md-12 mt-4">
    <div class="card border-0 shadow-sm">
        ...
        <th width="100">Action</th>
                ...
                <tbody>
                    @foreach ($sasdoctorsnontraining->details as $detail)
                        <tr class="detailRow">
                            <td>
                    ...
                    @endforeach
                    @if(count($sasdoctorsnontraining->details) == 0)
                        <tr class="detailRow">
...
<div class="col-12 text-end">
    ...
    <a href="{{ route('sas-doctors-grades-details.index') }}" 

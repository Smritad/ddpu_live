                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb mb-0">
										...
										<li class="breadcrumb-item active" aria-current="page">Join Membership Details</li>
									</ol>
								</nav>

								<a href="{{ route('joinmembership-details.create') }}" class="btn btn-primary px-5 radius-30">+ Add Join Membership Details</a>
							</div>

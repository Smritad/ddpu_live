                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                              ...
                              <form class="row g-4 needs-validation" novalidate action="{{ route('whychoose-details.update', $whychoose->id) }}" method="POST" enctype="multipart/form-data"> 
                                        @csrf
                                        @method('PUT')
                                            ...
                                            <div class="card shadow-sm">
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" name="main_heading" class="form-control" 
                                                        placeholder="Enter main heading" value="{{ $whychoose->main_heading }}" required>
                                            ...
                                            <div class="card shadow-sm">
                                                <div class="card-body">
                                                    ...
                                                    <table class="table table-bordered align-middle" id="whychooseTable">
                                                        ...
                                                        <tbody>
                                                            @foreach ($whychoose->details as $index => $detail)
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    @if(!empty($detail['icon']))
                                                                        <img class="icon-preview img-thumbnail" 
                                                                            src="{{ asset('whychoose-icons/'.$detail['icon']) }}" 

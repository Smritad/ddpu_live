            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add wTestimonials Details</li>
                </ol>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                  <form class="row g-4 needs-validation" novalidate action="{{ route('testimonials-details.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="main_heading" id="main_heading" class="form-control" placeholder="Enter main heading" required>
